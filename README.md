...
As an example application of the workflow, overlaps between atlas-defined regions and white matter tracts in diffusion MRI can be identified. To facilitate this, the JHU White-Matter Tractography Atlas (https://web.mit.edu/fsl_v5.0.10/fsl/doc/wiki/Atlases.html) is warped to subject space and binarized. Overlap between binarized tract masks and the target masks is then quantified using 3dcalc as follows:
